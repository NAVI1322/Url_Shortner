          ...
          <div className="flex flex-col items-center justify-center p-8 rounded-lg">
            ...
            <div className="flex flex-row mt-4">
              <div>
                ...
                <input className="w-[90%] bg-[#09090b] text-neutral-400 text-xl font-Regular outline outline-1 outline-neutral-700 p-3 rounded-lg" placeholder="John" />
              </div>
              <div>
                <p className="text-slate-100 font-Regular text-xl mb-2">Last name</p>
                <input className="w-full bg-[#09090b] text-neutral-400 text-xl font-Regular outline outline-1 outline-neutral-700 p-3 rounded-lg" placeholder="Doe" />
              </div>
            </div>
            <div className="w-full mt-4">
              <p className="text-slate-100 font-Regular text-xl mb-2">Email</p>
              <input className="w-full bg-[#09090b] text-neutral-400 text-xl font-Regular outline outline-1 outline-neutral-700 p-3 rounded-lg" placeholder="John@example.com" />
            </div>
            <div className="w-full mt-4">
              <p className="text-slate-100 font-Regular text-xl mb-2">Password</p>
              <input className="w-full bg-[#09090b] text-neutral-400 text-xl font-Regular outline outline-1 outline-neutral-700 p-3 rounded-lg" placeholder="" />
            </div>
            <div className="w-full mt-4">
              <button className="text-Grey bg-slate-100 font-semi text-xl p-3 w-full rounded-lg ">Sign up</button>
            </div>
            <div className="w-full mt-4">
